...
<head>
    ...
    <link rel="stylesheet" href="resource/css/ddcx.css" />
...
<div class="shade"></div>
<div class="tc" id="express_info">
    <p class="tc_close">
        <img src="resource/img/close_1.png" alt="" />
    </p>
    <p class="tc_title">订单查询确认页</p>
    <div class="tc_1 clearfix">
        <div class="tc_l">
            <p class="tc_p1">快递单号</p>
            <p class="tc_p2" id="express_number">88</p>
        </div>
        <div class="tc_r">
            <p class="tc_p1">确认重量</p>
            <p class="tc_p2" id="confirm_weight">88 KG</p>
        </div>
    </div>
    <div class="tc_2 clearfix">
        <div class="tc_l">
            <p class="tc_p1">快递图片</p>
            <p class="tc_img"></p>
        </div>
        <div class="tc_r">
            <p class="tc_p1">备注</p>
            <p class="tc_p2"><input type="text" name="" id="" value="" placeholder="请输入备注信息~" /></p>
            <p class="tc_btn" id="i">确认</p>
        </div>
    </div>
</div>
...
//        $('#confirm_weight').html(999);
        $.ajax({
            url:"order_d",
            type:"Post",
            data:{order_id:order_id},
            success:function(data){
                $('#express_number').html(data.express_number);
                $('#confirm_weight').html(data.confim_weight);
                $('.tc_btn').attr('id',data.order_id);
