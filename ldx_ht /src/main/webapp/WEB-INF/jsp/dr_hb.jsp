...
<div id="main">
    ...
    <div id="right">
        <div id="content">
            <div class="section">
                <p class="s_title">捐赠达人 >  海报1</p>
                <div class="s_box clearfix">
                    <div class="s_l">
                        <img src="http://www.xiaomingtuan.com/xiaobaige/resource/img/jzdr_hb1.png" alt="" />
                        <div class="del">x</div>
                    </div>
                    <div class="s_r">
                        <div class="s_r_t">
                            <p class="change_img">
                                +
                                <input type="file"  class="file" id="jzdr_hb1"/>
                            </p>
            ...
            <div class="section">
                <p class="s_title">捐赠达人 >  海报2</p>
                <div class="s_box clearfix">
                    <div class="s_l">
                        <img src="http://www.xiaomingtuan.com/xiaobaige/resource/img/jzdr_hb2.png" alt="" />
                        <div class="del">x</div>
                    </div>
                    <div class="s_r">
                        <div class="s_r_t">
                            <p class="change_img">
                                +
                                <input type="file"  class="file" id="jzdr_hb2"/>
                            </p>
                            <p class="s_p1">点击更换图片</p>
                            <p class="s_p2">当前图片大于2M，无法更换</p>
                        </div>
            ...
            <div class="section">
                <p class="s_title">捐赠达人 >  海报3</p>
                <div class="s_box clearfix">
                    <div class="s_l">
                        <img src="http://www.xiaomingtuan.com/xiaobaige/resource/img/jzdr_hb3.png" alt="" />
                        <div class="del">x</div>
                    </div>
                    <div class="s_r">
                        <div class="s_r_t">
                            <p class="change_img">
                                +
                                <input type="file"  class="file" id="jzdr_hb3"/>
                            </p>
                            <p class="s_p1">点击更换图片</p>
                            <p class="s_p2">当前图片大于2M，无法更换</p>
                        </div>
